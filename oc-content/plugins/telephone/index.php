            ...
            if (osc_get_preference('hide_digits', 'telephone') == '1') {
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        ...
                        $('.phone_telephone span').click(function () {
                            $(this).html(number);
                        });
                    });
                </script>
                <div style="display:block;margin-bottom:5px;cursor:pointer;" class="phone_telephone" ><?php _e('Phone', 'telephone'); ?>: <span title="<?php _e('Click to show the number', 'telephone'); ?>"><?php echo telephone_replace_number_to_x($detail['s_telephone']); ?></span></div>
                <?php
            } else {
                ?>
